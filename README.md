...
1. **Join our Support Group**: Type `#script` in our [support group](https://t.me/x_support_chat) to get the necessary script.
...
## 🚀 Deploy on Heroku 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/Notookk/Akshu-V1)
...
5. **Clone the Repository**
   ```bash
   git clone hhttps://github.com/Notookk/AkshuMusic && cd AviaxMusic
   ```
...
For a full list of commands, use `/help` in [telegram](https://t.me/Akshumusic_bot).
...
<p align="center">
  <a href="https://telegram.me/x_support_chat">
